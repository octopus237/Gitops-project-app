pipeline {
    ...
    stages {
        ...
        stage('Notify the Gitops team'){
            steps{
                discordSend description: " **Jenkins build result of app:** ${DOCKERHUB_USENAME}/${APP_NAME}:${DOCKERTAG} ", footer: 'Large Systems Project', image: '', link: env.BUILD_URL, successfull: true, result: currentBuild.currentResult, title: 'discord notifier', webhookURL: 'https://discord.com/api/webhooks/1085999261877030942/uJ-bws-LGiyHi1ORxp4cY4by8aiX-AXciU3p_FEef8k9R-4o00IvhOaO_xBwjf_5aLTv'
            }
        }
    }
}
